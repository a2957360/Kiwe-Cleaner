...
class MyTaskDetail extends Component {
	...
	navigateToServicePolicy = () => {
		this.setState({ taskTakenOverlayVisible: false }, () => this.props.navigation.navigate('ServicePolicy'));
	};

	navigateToCheckinForm = orderId => {
		this.props.navigation.navigate('CleanerCheckinForm', orderId);
	};
	...
	render() {
		...
		let taskTakenConfirmOverlay;
		let taskCommentButton;
			...
			taskDetailInfoSection = (
				<View>
					<View style={styles.taskContentContainer}>
						...
						<View style={styles.taskDetailCostContainer}>
							...
							<View style={styles.taskStateBox}>
								<Text style={styles.taskStateText}>{taskDetail.typeName}</Text>
							</View>
						</View>
					</View>
					...
					<View style={styles.taskSecondContentContainer}>
						...
						<Text style={styles.orderExtraRequireText}>{taskDetail.orderExtraRequire}</Text>
					</View>
				</View>
			);
							...
							<View
								style={
									this.state.policyChecked === true
										? globalStyles.yellowMediumButton
										: globalStyles.lightGreyMediumButton
								}
							>
								<Text
									style={
					...
					return (
						<View style={globalStyles.whiteBackgroundContainer}>
							...
							<View style={globalStyles.bottomDoubleButtonContainer}>
								...
								<TouchableOpacity onPress={() => this.navigateToCheckinForm(taskDetail.orderId)}>
									<View style={globalStyles.yellowLargeButton}>
						...
						<View style={globalStyles.whiteBackgroundContainer}>
							...
							<View style={globalStyles.bottomSingleButtonContainer}>
								<TouchableOpacity onPress={() => this.changeTaskStatus(taskDetail.orderId, 5)}>
									<View style={globalStyles.yellowLargeButton}>
										<Text style={globalStyles.blackButtonText}>确认完成</Text>
									</View>
								</TouchableOpacity>
							</View>
						</View>
